...
For example, in the [example in the Usage section](require-directory.md#usage) we could have avoided creating `routes/index.js` and instead changed the first lines of `app.js` to:
