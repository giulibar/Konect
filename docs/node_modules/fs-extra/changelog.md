...
* copy failed to return an error to the callback if a file doesn't exist \(ulikoehler [\#38](https://github.com/jprichardson/node-fs-extra/pull/38), [\#39](https://github.com/jprichardson/node-fs-extra/pull/39)\)
