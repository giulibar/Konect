...
* [Commander.js](commander.md#commanderjs)
  * [Installation](commander.md#installation)
  * [Declaring _program_ variable](commander.md#declaring-program-variable)
  * [Options](commander.md#options)
    * [Common option types, boolean and value](commander.md#common-option-types-boolean-and-value)
    * [Default option value](commander.md#default-option-value)
    * [Other option types, negatable boolean and flag\|value](commander.md#other-option-types-negatable-boolean-and-flagvalue)
    * [Custom option processing](commander.md#custom-option-processing)
    * [Version option](commander.md#version-option)
  * [Commands](commander.md#commands)
    * [Specify the argument syntax](commander.md#specify-the-argument-syntax)
    * [Action handler \(sub\)commands](commander.md#action-handler-subcommands)
    * [Git-style executable \(sub\)commands](commander.md#git-style-executable-subcommands)
  * [Automated --help](commander.md#automated---help)
    * [Custom help](commander.md#custom-help)
    * [.usage and .name](commander.md#usage-and-name)
    * [.outputHelp\(cb\)](commander.md#outputhelpcb)
    * [.helpOption\(flags, description\)](commander.md#helpoptionflags-description)
    * [.help\(cb\)](commander.md#helpcb)
  * [Custom event listeners](commander.md#custom-event-listeners)
  * [Bits and pieces](commander.md#bits-and-pieces)
    * [TypeScript](commander.md#typescript)
    * [Node options such as `--harmony`](commander.md#node-options-such-as---harmony)
    * [Node debugging](commander.md#node-debugging)
  * [Examples](commander.md#examples)
  * [License](commander.md#license)
  * [Support](commander.md#support)
